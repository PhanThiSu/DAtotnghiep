		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header with-border row" id="reports-header">
					...
					<div class="col-sm-6">
						<h3 class="box-title text-info pull-right text-right">This Month <?=vendor_html_helper::link($this->fullname, ["ctl"=>"reports", "act"=>"profile"])?> has had notifiactions <strong class="text-danger"><?=$this->notificationsTotal;?></strong></h3>
					</div>
			    </div>
			    <div class="box-header">
		    		<div class="row" id="reports-header">
		    			<div class="col-sm-9 col-xs-9">
			      			<form id="form-report" action="<?php echo vendor_app_util::url(["ctl"=>"notifications", "act"=>'month']); ?>" method="post" enctype="multipart/form-data" class="form-inline">

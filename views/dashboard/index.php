  ...
  <div class="row">
    <div class="col-lg-4 .col-sm-4 ">
      ...
      <div class="small-box bg-aqua small-dashboard">
        <div class="inner">
          <h3 class="smallMobileHide"><a class="daily" alt="today" href="<?=vendor_app_util::url(array('ctl'=>'reports', 'act'=>'week')); ?>"> <?=$this->thisWeekReports;?> Báo cáo trong tuần</a></h3>
    ...
    <div class="col-lg-4 .col-sm-4 ">
      ...
      <div class="small-box bg-green small-dashboard">
        <div class="inner">
          <h3 class="smallMobileHide"><a  class="daily" alt="today" href="<?=vendor_app_util::url(['ctl'=>'requests', 'act'=>'week']); ?>"><?=$this->noUnprocessRequestsWeek;?> Phép trong tuần</a></h3>
    ...
    <div class="col-lg-4 .col-sm-4 ">
      ...
      <div class="small-box bg-blue small-dashboard">
        <div class="inner">
          <h3 class="smallMobileHide"><a class="daily" alt="today" href="<?=vendor_app_util::url(array('ctl'=>'notifications')); ?>"> <?=$this->thisWeekNotifications;?> Notification Week</a></h3>

          <p><a class="daily" alt="yesterday" href="<?=vendor_app_util::url(array('ctl'=>'notifications')); ?>"><?=$this->noTodayNotifications;?> Notification today</a></p>
        </div>
        <div class="icon">
          <i class="ion ion-bag"></i>
        </div>
        <a href="<?php echo vendor_app_util::url(array('ctl'=>'notifications')); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- ./col -->
    <div class="col-lg-4 .col-sm-4 ">

			...
			<div class="box">
			    ...
			    <div class="box-body row">
					...
					<div class="col-sm-9 col-xs-9">
		      			...
		      			<form id="form-report" action="<?php echo vendor_app_util::url(["ctl"=>"fund_salaries", "act"=>'listsMonth']); ?>" method="post" enctype="multipart/form-data" class="form-inline">
                                ...
                                <?php if (isset($this->record)) { ?>
                                    ...
                                    <?php foreach($this->record as $k=>$v) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a type="button" class="btn btn-success view-record usermonth" alt="<?=$this->time.'-'.(($i<10)? '0':'').$i;?>" href="<?=vendor_app_util::url(array('ctl'=>'user_month_salaries','act'=>'view?year='.$this->year.'&month='.$i)); ?>"><i class="fa fa-eye" aria-hidden="true"></i>
                                                </a>
                                            </td>
                                        </tr>
                                        <?php $i++; ?>

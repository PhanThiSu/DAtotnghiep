		...
		<div class="col-xs-12">
			<div class="box">
			    <div class="box-header with-border row" id="reports-header">
					<h3 class="box-title box-header">Daily user reports  <?php if ($app['act'] == "usersOTreport")  echo "OT"  ?> </h3>
			    </div>
	    			...
	    			<div class="col-sm-10 col-xs-10">
	    				<div class="row">
							<div class="btn-group btn-toggle col-md-4"> 
			      			...
			      			<form id="form-report-month" action="<?php echo vendor_app_util::url(["ctl"=>"reports", "act"=>'usersOTreport']); ?>" method="post" enctype="multipart/form-data" class="form-inline form-report col-md-8 <?=($this->timetype=='month')? '':'hide';?>">
			                ...
			                <form id="form-report-week" action="<?php echo vendor_app_util::url(["ctl"=>"reports", "act"=>'usersOTreport']); ?>" method="post" enctype="multipart/form-data" class="form-inline form-report col-md-8 <?=($this->timetype=='week')? '':'hide';?>">
			                  	<div class="form-group">
			      			...
			      			<form id="form-report-date" action="<?php echo vendor_app_util::url(["ctl"=>"reports", "act"=>'usersOTreport']); ?>" method="post" enctype="multipart/form-data" class="form-inline form-report col-md-8 <?=($this->timetype=='date')? '':'hide';?>">
								<div class="form-group">

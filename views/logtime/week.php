		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header with-border row" id="reports-header">
					...
					<div class="col-sm-6">
						<h3 class="box-title text-info pull-right text-right">This Week <?=vendor_html_helper::link($this->fullname, ["ctl"=>"reports", "act"=>"profile"])?> has worked <strong class="text-danger"><?=$this->timetotal;?></strong> hour(s)</h3>
					</div>
			    </div>

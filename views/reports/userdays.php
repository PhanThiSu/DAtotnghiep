		...
		<div class="col-xs-12">
			<div class="box">
			    <div class="box-header with-border row" id="reports-header">
					...
					<div class="col-sm-6">
						<h3 class="box-title text-info pull-right text-right">In <a class="dayweek" alt="<?=$this->time;?>" href="<?=vendor_app_util::url(array('ctl'=>'reports', 'act'=>'profile')); ?>"><?=$this->time;?></a>, <?=vendor_html_helper::link($this->fullname, ["ctl"=>"users", "act"=>"profile"])?> have worked <strong class="text-danger"><?=number_format((float)$this->record['total'] , 1, '.', '');?></strong> hour(s)</h3>
					</div>
			    </div>

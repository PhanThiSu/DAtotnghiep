...
class user_month_salaries_controller extends vendor_backend_controller
{
    ...
    public function getDataUserMonthSalary($month,$year){
        ...
        $salaries = $month_salary_model->getAllRecords("user_month_salaries.id as id,user_month_salaries.status as status_payment,bonus,salary,user_id,bonus_description", ['conditions' => $conditions,'joins'=>['user_month_setting']]);
    ...
    public function month_setting()
    {
        ...
        $this->record['time_required'] = (date('t') - $this->record['day_off'])*8;
        $this->display();
    }

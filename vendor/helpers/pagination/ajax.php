	...
	<div class="dataTables_paginate paging_simple_numbers" id="table_paginate">
		<ul class="pagination pull-right">
			<li class="paginate_button previous disabled" id="table_previous">
				<a href="javascript:void(0);" aria-controls="example1" data-dt-idx="<?=($curp-1); ?>" tabindex="0">Trước</a>
			</li>
			...
			<li class="paginate_button next" id="table_next">
				<a href="javascript:void(0);" aria-controls="example1" data-dt-idx="<?=($curp+1); ?>" tabindex="0">kế tiếp
				</a>
			</li>
		</ul>
	</div>
